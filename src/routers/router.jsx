  ...
  const router = createBrowserRouter([
    {
      ...
      children: [
        ...
        },
        {
            path:"/book/:id",
            element: <SingleBook/>,
            loader: ({params}) => fetch(`https://mmbackend-zv50.onrender.com/book/${params.id}`)
        },
        {
          path: "/book-search",
          element: <Search/>,
          loader: ({request}) => {
            ...
            return fetch(`https://mmbackend-zv50.onrender.com/book-search?search=${query}`)
          }
        }
      ]
    },
      ...
      children: [
        {
          ...
          loader: async () => {
            ...
            return fetch(`https://mmbackend-zv50.onrender.com/admin/${id}`);
          }
        },
        {
        ...
        },
        {
          ...
          element: <EditCards/>,
          loader: ({params}) => fetch(`https://mmbackend-zv50.onrender.com/card/${params.id}`)
        }
      ]
    },
    {
